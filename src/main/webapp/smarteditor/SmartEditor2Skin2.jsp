...
<div id="smart_editor2">
	<div id="smart_editor2_content"><a href="#se2_iframe" class="blind">글쓰기영역으로 바로가기</a>
		...
		<div class="se2_conversion_mode">
			...
			<li class="active" style="display:none;"><button type="button" class="se2_to_editor"><span>Editor</span></button></li>
			<li style="display:none;"><button type="button" class="se2_to_html"><span>HTML</span></button></li>
